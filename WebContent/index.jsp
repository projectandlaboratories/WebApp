            ...
            <div class="container-fluid" style="height: 70px;padding-right: 0px;padding-left: 0px;">
                <h1 class="d-lg-flex align-items-lg-center" style="background-color: rgb(44,62,80);height: 70px;vertical-align: middle;">
                	<a class="btn btn-link d-xl-flex align-items-xl-center" role="button" id="menu-toggle" href="#menu-toggle" style="height: 70px;">
                		<img src="images/md-reorder-white.svg" style="height: 100%;"></a><a class="navbar-brand text-left flex-fill"
                    ...
                    <button
                        class="btn btn-primary text-center d-lg-flex justify-content-lg-center align-items-lg-center" type="button" style="height: 70px;margin-left: 8px;width: 60px;background-color: rgb(44,62,80);margin-right: 8px;position: absolute;right: 2px;">
                        	<img src="images/ios-settings-white.svg"  style="width:100%;" ></img>
                     	</button>
                ...
                <div style="position: absolute;bottom: 100px;height: 70px;font-size: 70px;">
              		<button class="btn btn-light btn-lg text-center text-primary border-white" type="button" style="font-size: 50px;width: 90px;height: 90px;background-color: rgb(255,255,255);"><img src="images/ios-flame-primary.svg"></button>
              		<button class="btn btn-light btn-lg text-center text-primary border-white" type="button" style="font-size: 50px;width: 90px;height: 90px;background-color: rgb(255,255,255);"><img src="images/ios-snow-primary.svg"></button>
              		<button class="btn btn-light btn-lg text-center text-primary border-white" type="button" style="font-size: 50px;width: 90px;height: 90px;background-color: rgb(255,255,255);"><img src="images/ios-thermometer-primary.svg"></button>
                    <button class="btn btn-light btn-lg text-center text-primary border-white" type="button" style="font-size: 50px;width: 90px;height: 90px;background-color: rgb(255,255,255);"><img src="images/ios-flower-primary.svg"></button>
                    <button class="btn btn-light btn-lg text-center text-primary border-white" type="button" style="font-size: 50px;width: 90px;height: 90px;background-color: rgb(255,255,255);"><img src="images/md-hand-primary.svg" ></button>
                </div>
