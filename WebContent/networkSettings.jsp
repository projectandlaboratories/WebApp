...
<body>
    ...
    <div style="width: 100%;position: absolute;bottom:0px;top: 40%;left:25%;right:0px;display: inline-block;vertical-align: middle;flex-direction:column;display:flex;">
        <div class="dropdown" style="width: 50%;margin-bottom: 2%;height: 60px;">
        ...
        <input type="password" style="width: 50%;height: 60px;">
        <button class="btn btn-primary" type="button" style="margin-top: 2%;width:25%;margin-left: 12.5%;">Connect</button>
    </div>
