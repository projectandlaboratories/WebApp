...
<div id="load" class="hide"></div>
  <h1 class="d-lg-flex align-items-lg-center" style="background-color: rgb(44,62,80);height: 70px;">
      ...
      <button onclick = "changeChart('<%=request.getContextPath()%>/pages/statistics.jsp?room=${param.room}&chart=<%=prevKey%>')" class="btn btn-light text-center text-primary bg-light d-lg-flex justify-content-lg-center align-items-lg-center" style="height: 60px; width: 60px; top:50%; position: absolute;left: 1%;;font-size: 30px;">
      ...
      <button onclick = "changeChart('<%=request.getContextPath()%>/pages/statistics.jsp?room=${param.room}&chart=<%=nextKey%>')" class="btn btn-light text-center text-primary bg-light d-lg-flex justify-content-lg-center align-items-lg-center" style="height: 60px; width: 60px; top:50%; position: absolute;right: 1%;font-size: 30px;">
