...
<form action="<%=request.getContextPath()+"/newProgramServlet"%>" method="POST">          
    ...
    <footer class="d-lg-flex align-items-lg-center" style="height: 60px; background-color: #ecf0f1;vertical-align: middle; position: absolute; right: 0px; left: 0px">
     	<a class="btn btn-light text-center text-primary bg-light d-lg-flex justify-content-lg-center align-items-lg-center" onclick="showLoadingIcon()" href="profileSetTemperature.jsp?action=<%=myaction%>" style="height: 60px;padding-top: 6px;margin-left: 2px; position: absolute;font-size: 30px;">
